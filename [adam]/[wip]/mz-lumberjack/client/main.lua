...
CreateThread(function()
    exports['qb-target']:AddBoxZone("selllumberitems", vector3(-567.43, 5252.99, 70.48), 1.1, 0.8, {
...
CreateThread(function()
    for _, value in pairs(Config.LumberLocation) do
        ...
        AddTextComponentSubstringPlayerName("Ryker's Lumber")
...
CreateThread(function()
    for _, value in pairs(Config.SellLocation) do
        ...
        SetBlipColour(blip, 2)
        BeginTextCommandSetBlipName('STRING')
        AddTextComponentSubstringPlayerName("Rykers's Lumber Yard")
        EndTextCommandSetBlipName(blip)
    end
end)
