...
-- Lap dance 
Config.LapDanceCost					= 2000 		-- Cost of the lap dance
Config.ThrowCost					= 100 		-- Cost of the lap dance
Config.LegMoney                     = 5000     -- Little easter egg for your player, will add an accessory "Leg money" to the stripper if the player has more than 'Config.LegMoney' in cash. Set to a huge value if you don't want this
Config.Nudity                       = true      -- Set to true if you want the stripper to be topless (Only for player above 'Config.NudityAge')
Config.NudityAge                    = 18        -- (QBCore only!!) Player age restriction. If underage and 'Config.Nudity' is set to true, the stripper won't be topless. Set to 0 if you don't want age restriction
...
Config.BlipName                     = "Vanilla Unicorn" -- Blip name
...
Config.LapMarker					= false		-- Set to true if you want the marker for the lapdance to be "drawn"
