...
Config.ForceInjury = 45 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
...
Config.FadeOutTimer = 5 -- How many bleed ticks occur before fadeout happens
Config.BlackoutTimer = 10 -- How many bleed ticks occur before blacking out
Config.AdvanceBleedTimer = 15 -- How many bleed ticks occur before bleed level increases
...
Config.HeadInjuryChance = 20 -- The chance, in percent, that head injury side-effects get applied
Config.LegInjuryChance = { -- The chance, in percent, that leg injury side-effects get applied
    Running = 25,
    Walking = 5
}
Config.MajorArmoredBleedChance = 5 -- The chance, in percent, that a player will get a bleed effect when taking heavy damage while wearing armor
