...
--function SpawnWorkObjects()
 ...
 --   exports['qb-core']:RequestModelHash(v['Prop'])
...
function MakeBurger(BurgerName)
  Citizen.SetTimeout(750, function()
    ...
    exports['qb-core']:RequestAnimationDict("mini@repair")
...
function MakeFries()
  ...
  exports['qb-core']:RequestAnimationDict("amb@prop_human_bbq@male@base")
