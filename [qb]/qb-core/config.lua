...
QBConfig.UpdateInterval = 15 -- how often to update player data in minutes
...
QBConfig.Money.PayCheckTimeOut = 5 -- The time in minutes that it will give the paycheck
...
QBConfig.Server.Discord = "https://discord.gg/XXQvFKNKqF" -- Discord invite link
