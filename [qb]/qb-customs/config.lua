...
Config.DefaultRepairPrice = 800 -- Repair price that is used if a vehicle-specific price is not available
Config.BaseRepairPrice = 200 -- Starting repair price. Every player's vehicle damage (0-1000) is added to it later. If the final price is 0 or less, the repair menu does not appear
