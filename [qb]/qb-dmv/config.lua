...
Config.Location = {
  ['marker'] = vector3(-1083.12, -245.74, 37.76),           --Location of Blip for DMV School and Location of Start Marker if Config.UseNewQB = false
  ['spawn'] = vector4(236.08, -1401.41, 30.58, 265.06),    -- Location to spawn vehicle upon starting Drivers Test
  ['coords'] = vector4(-1083.12, -245.74, 37.76, 193.97),    -- Location of Ped if Config.UseTarget True or Loction of QB:DrawText Area if Config.UseTarget = false and Config.UseNewQB = true
