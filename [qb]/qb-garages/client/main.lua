    ...
    if HouseGarages[house] then     
        ...
        Polyzone:onPlayerInOut(function(isPpointInside)
            if isPpointInside then
                inHouseParking = true
                exports['qb-core']:core('Parking','left')
            else
...
alap01:onPlayerInOut(function(isPointInside)
    if isPointInside then
        inParkingZone = true
        currentgarage = "alta"
        exports['qb-core']:DrawText('[F1] Parking','left')
    else
        inParkingZone = false
        exports['qb-radialmenu']:RemoveOption(5)
        exports['qb-core']:HideText()	
...
local bannerhotel = PolyZone:Create({
    vector2(-1657.54, -546.76),
    vector2(-1663.06, -551.53),
    vector2(-1686.39, -537.51),
    vector2(-1678.08, -532.61),
    vector2(-1668.24, -537.64),
    }, {
        name="bannerhotel",
        minZ = 34.00-3,
        maxZ = 34.00+3,
})
bannerhotel:onPlayerInOut(function(isPointInside)
    if isPointInside then
        inParkingZone = true
        currentgarage = "bannerhotel"
        exports['qb-core']:DrawText('[F1] Parking','left')
    else
        inParkingZone = false
        exports['qb-radialmenu']:RemoveOption(5)
...
mrpd:onPlayerInOut(function(isPointInside)
    if isPointInside then
        inParkingZone = true
        currentgarage = "mrpd"
        exports['qb-core']:core('[F1] Parking','left')
    else
        inParkingZone = false
        exports['qb-radialmenu']:RemoveOption(5)
        exports['qb-core']:HideText()	
...
hayesdepot:onPlayerInOut(function(isPointInside)
    if isPointInside then
        ...
        exports['qb-core']:DrawText('[F1] Depot','left')
    else
        inDepotZone = false
        exports['qb-radialmenu']:RemoveOption(5)
        exports['qb-core']:HideText()	
