...
CreateNPC = function()
    created_ped = CreatePed(5, GetHashKey('a_m_y_business_03') , vector4(-1682.43, -533.1, 35.62, 213.55), false, true)
...
AddEventHandler('qb-rental:spawncar', function(data)
    ...
    QBCore.Functions.SpawnVehicle(model, function(vehicle)
        ...
        SpawnVehicle = true
    end, vector4(-1700.28, -559.93, 35.9, 132.51), true)
    Wait(1000)
...
CreateThread(function()
    blip = AddBlipForCoord(-1686.44, -530.98, 37.0)
