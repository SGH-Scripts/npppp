...
Config.RemoveLockpickAdvanced = 0.05 -- Chance to remove advanced lockpick on fail
Config.LockPickDoorEvent = function() -- This function is called when a player attempts to lock pick a vehicle
    TriggerEvent('qb-lock:client:StartLockPickCircle', LockpickFinishCallback)
end
...
Config.PoliceAlertChance = 0.80 -- Chance of alerting police during the day
Config.PoliceNightAlertChance = 0.20 -- Chance of alerting police at night (times:01-06)
